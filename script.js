    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אוראל חזן צילום טבעי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '5ea30552-03df-4a95-ae0d-b38e7a40a2c6',
                    name: data.name || '',
                    email: data.email || '',
